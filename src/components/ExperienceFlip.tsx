...
const ExperienceFlip = () => {
  ...
  return (
    <section id="experience" className="py-20 relative overflow-hidden" style={{
      background: 'linear-gradient(135deg, #0f172a 0%, #1e293b 25%, #1a1a2e 50%, #2d3748 75%, #0f172a 100%)',
      ...
      <div className="absolute inset-0 opacity-8">
        <div className="absolute top-20 left-1/4 w-96 h-96 bg-gradient-to-br from-green-500 to-green-700 rounded-full mix-blend-screen filter blur-3xl" style={{ animation: 'float-slow 8s ease-in-out infinite' }}></div>
        <div className="absolute top-40 right-10 w-96 h-96 bg-gradient-to-br from-teal-500 to-teal-700 rounded-full mix-blend-screen filter blur-3xl" style={{ animation: 'float-slow 10s ease-in-out infinite 1s' }}></div>
        <div className="absolute -bottom-8 left-1/3 w-96 h-96 bg-gradient-to-br from-blue-600 to-blue-800 rounded-full mix-blend-screen filter blur-3xl" style={{ animation: 'float-slow 9s ease-in-out infinite 2s' }}></div>
      </div>
