...
const Achievements = () => {
  ...
  return (
    <section id="achievements" className="py-20 relative overflow-hidden" style={{
      ...
      <div className="absolute inset-0 opacity-8">
        <div className="absolute top-20 right-1/3 w-96 h-96 bg-gradient-to-br from-orange-500 to-orange-700 rounded-full mix-blend-screen filter blur-3xl" style={{ animation: 'float-slow 8s ease-in-out infinite' }}></div>
        <div className="absolute top-40 left-10 w-96 h-96 bg-gradient-to-br from-yellow-500 to-yellow-700 rounded-full mix-blend-screen filter blur-3xl" style={{ animation: 'float-slow 10s ease-in-out infinite 1s' }}></div>
        <div className="absolute -bottom-8 right-10 w-96 h-96 bg-gradient-to-br from-amber-500 to-amber-700 rounded-full mix-blend-screen filter blur-3xl" style={{ animation: 'float-slow 9s ease-in-out infinite 2s' }}></div>
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16 animate-fade-in-up">
            <h2 className="text-5xl md:text-6xl font-bold mb-4 text-white">Akshaya Kumar</h2>
            <h3 className="text-3xl md:text-4xl font-bold mb-6 text-white">Research & Achievements</h3>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex gap-3 pt-4 border-t border-glass-border">
                      <Button
                        ...
                        asChild
                      >
                        <a href={paper.paperLink} target="_blank" rel="noopener noreferrer" title="Open presentation deck">
                      ...
                      <Button
                        ...
                        asChild
                      >
                        <a href={paper.citationImage} target="_blank" rel="noopener noreferrer" title={paper.citationLabel ?? "View citation proof"}>
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3 mb-3">
                            <h4 className="font-bold text-primary leading-tight">{achievement.title}</h4>
                          ...
                          <p className="text-sm text-muted-foreground leading-relaxed">{achievement.note}</p>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <Card className="glass-effect border-0 text-center hover:bg-primary/20 hover:border-primary/40 transition-all duration-300 transform hover:scale-105 animate-fade-in-up">
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-muted-foreground">Research Paper Published</p>
                </CardContent>
              </Card>
              ...
              <Card className="glass-effect border-0 text-center hover:bg-primary/20 hover:border-primary/40 transition-all duration-300 transform hover:scale-105 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                <CardContent className="p-6">
                  <div className="text-3xl font-bold text-primary mb-2">3+</div>
                  <p className="text-sm text-muted-foreground">Hackathon Participations</p>
                </CardContent>
              </Card>
          ...
          <div className="text-center mt-16 animate-fade-in-up" style={{ animationDelay: '0.8s' }}>
            <Card className="glass-effect border-0 max-w-2xl mx-auto hover:bg-primary/20 hover:border-primary/40 transition-all duration-300 animate-fade-in-up">
              <CardContent className="p-8">
                <h4 className="text-2xl font-bold mb-4 text-primary">Interested in Collaboration?</h4>
