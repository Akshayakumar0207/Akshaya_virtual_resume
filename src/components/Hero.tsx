import { ArrowDown, Download, Github, Linkedin, Mail, Briefcase } from "lucide-react";
import { Button } from "@/components/ui/button";
import heroImage from "@/assets/hero-bg.jpg";
import profileImage from "@/assets/ak-profile.png";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2 flex justify-center animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
              <div className="relative">
                ...
                {/* Open to Work Badge */}
                <div className="absolute bottom-0 right-0 bg-green-500 text-white px-4 py-2 rounded-full flex items-center gap-2 shadow-lg animate-pulse">
                  <Briefcase size={16} />
